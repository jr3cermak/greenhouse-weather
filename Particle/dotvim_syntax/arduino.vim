" Vim syntax file
" Language:    Arduino/Particle
" Modified:    Rob Cermak <rob.cermak@gmail.com>
...
" Thanks to original author Johannes Hoff and Rik, Erik Nomitch, 
" Adam Obeng and Graeme Cross for helpful feedback!
...
"}}}
"Particle keywords
        syn keyword arduinoFunc Timer USARTSerial USBSerial TwoWire Cellular
        syn keyword arduinoFunc start function variable count
"QueueList library
        syn keyword arduinoFunc QueueList
